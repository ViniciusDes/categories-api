...
### Esse projeto foi construído usando Node com Typescript, Express, Database Oracle SQL, TypeOrm, Docker e Docker-Compose e Jest para os testes.
...
- ##### Execute o comando para executar a aplicação: **docker-compose up -d** e **docker-compose up** para acompanhar os logs do container 
