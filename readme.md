...
### Esse projeto foi construído usando Node com Typescript, Express, Database Oracle SQL, Docker e Docker-Compose e Jest para os testes.
...
- ##### Foi deixado o arquivo .env visivel para ajudar a testar
